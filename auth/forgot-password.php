    ...
    if ($error === '') {
        try {
            ...
            if ($accountExists) {
                ...
                $lastRequest = $cooldown->fetchColumn();
                $canSend = true;

                if ($lastRequest) {
                    $lastTime = strtotime(
                        (string)$lastRequest . ' UTC'
                    );
                ...
                if ($canSend) {
                    ...
                    /*
                     * Local/XAMPP: nếu chưa cấu hình SMTP,
                     * vẫn cho phép test bằng link reset.
                     * Khi SMTP hoạt động, link sẽ được gửi email.
                     */
            ...
            $message =
                ...
                . 'hệ thống đã tạo liên kết đặt lại mật khẩu.';
...
<a href="../" class="reset-auth-brand">FASHION<span>SHOP</span></a>
...
<button type="submit" class="reset-auth-submit">
...
<?php endif; ?>
<a href="login.php" class="reset-auth-back">
    ← Quay lại đăng nhập
</a>
</section>
</main>
