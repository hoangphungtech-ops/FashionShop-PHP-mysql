...
<header class="policy-intro">
    ...
    <p class="policy-lead">
        FashionShop hỗ trợ giao hàng trên toàn quốc,
        với quy trình rõ ràng và thông tin đơn hàng
        được cập nhật xuyên suốt.
    </p>
...
<section class="policy-row">
    ...
    <div class="policy-content">
        ...
        <small>
            Thời gian trên là dự kiến và
            có thể thay đổi tùy khu vực.
        </small>
...
<section class="policy-row">
    ...
    <div class="policy-content">
        Phí vận chuyển có thể thay đổi
        tùy theo khu vực, phương thức giao hàng
        và giá trị đơn hàng.
    </div>
...
<section class="policy-row">
    ...
    <div class="policy-content">
        ...
        xử lý đơn hàng trong hệ thống FashionShop.
    </div>
...
<section class="policy-row">
    ...
    <div class="policy-content">
        ...
        Thời gian giao hàng có thể thay đổi do:
