...
function getProductImage($image)
{
    ...
    /* Danh sách các đường dẫn kiểm tra trên máy */
    $paths = [
...
<head>
    ...
    <style>
        ...
        .products-page .product-card:hover {
            ...
            box-shadow: 0 12px 30px rgba(38, 49, 38, 0.09);
        }
...
<header class="header">
    <div class="container header-content">
        ...
        <nav class="nav">
            ...
            <!-- Đã khớp ID: Áo=2, Quần=4, Váy=1 -->
            <a href="index.php?category=2">Áo</a>
            <a href="index.php?category=4">Quần</a>
            <a href="index.php?category=1">Váy</a>
        </nav>
...
<section class="products-page">
    <div class="container">
        <div class="products-page-header">
            ...
            <p>Khám phá những sản phẩm thời trang trẻ trung, hiện đại và phù hợp với phong cách của bạn.</p>
        </div>

        <!-- CATEGORY FILTER -->
        <div class="category-filter">
            <a href="index.php" class="<?= $category === 0 ? 'active' : '' ?>">Tất cả</a>
            <a href="index.php?category=2" class="<?= $category === 2 ? 'active' : '' ?>">Áo</a>
            <a href="index.php?category=4" class="<?= $category === 4 ? 'active' : '' ?>">Quần</a>
            <a href="index.php?category=1" class="<?= $category === 1 ? 'active' : '' ?>">Váy</a>
        </div>
            ...
            <?php if (!empty($products)): ?>
                <?php foreach ($products as $product): ?>
                    ...
                    <div class="product-card">
                        <a href="detail.php?id=<?= (int) $product['id'] ?>" class="product-image">
    ...
    <?= number_format((float) ($product['price'] ?? 0) * 1000, 0, ',', '.') ?>đ
            ...
            <?php else: ?>
                <div class="products-empty">
                    ...
                    <p>Hiện tại chưa có sản phẩm phù hợp để hiển thị.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
